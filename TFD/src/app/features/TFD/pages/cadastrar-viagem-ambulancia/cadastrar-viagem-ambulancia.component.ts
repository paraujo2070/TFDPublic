...
@Component({
  selector: 'app-cadastrar-viagem-ambulancia',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule
  ],
  templateUrl: './cadastrar-viagem-ambulancia.component.html',
  styleUrls: ['./cadastrar-viagem-ambulancia.component.css']
})
export class CadastrarViagemAmbulanciaComponent {
  hospitais: string[] = [''];
  horarios: string[] = [''];

  constructor() { }

  cadastrarViagemAmbulancia(formulario: NgForm): void {
    if (formulario.valid) {
